...
def good_ending():
    ...
    time.sleep(3)
    print('The lessons you\'ve learned here will forever stay with you.\n')
    time.sleep(3)
...
#Game section:
#I will add a variable called playing and set it to True. Then, the game will be in a while True loop. 
# If the user wants to play again they jusy continue. If not, it will break out of the loop!
playing = True
while playing:
    linebreak()
    print()
